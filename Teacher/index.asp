					...
					<tr>
						<td>
							...
							<table class="tbl" id="Table2" cellSpacing="0" cellPadding="0" width="760" border="0">
								...
								<tr width=100%>
									<td width=45%>&nbsp;教师<font color=blue><%=session("teacherNumber")%></font>,你好，你的登陆时间是:<%=Now%></td><td width=35%></td><td width=20%>&nbsp;</td>
								</tr>
							</table>
							...
							<table class="lrb" align="center" cellSpacing="0" cellPadding="0" width="760" border="0"
								...
								<tr>
									...
									<iframe style="height: 550px; width: 760px;" frameborder="0" name="ContentFrame" scrolling="yes" src="../System/systemInfo.asp" width="760"></IFRAME>
									</td>
								</tr>
							</table>
							<!--   /内容层   -->
