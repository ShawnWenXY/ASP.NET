...
<%
  dim sqlString,teachId,teachInfoRs,courseName,termName
  '如果教师还没有登陆
  if session("teacherNumber")="" and  session("adminUsername")="" then
	...
	if not teachInfoRs.EOF then
	  '取得上课的课程的名称
	  courseName = GetPublicCourseNameByNumber(teachInfoRs("courseNumber"))
	  '取得该上课信息所在的学期信息
 ...
 <form method="post" name="frmAnnounce" runat="server">
	 <table width=700 border=0 cellpadding=0 cellspacing=0 align="center">
	     ...
	     <td style="height: 14px" colspan=2 align="center">
		      <img src="../images/list.gif" width=14px height=14px>排课信息管理--&gt;班级课程详细排课信息查看
			 </td>
	   </tr>
		 <tr>
        ...
        <td height="30" colspan="2" align="center">
				 <input type="button" value="返回" onClick="javascript:location.href='teachInfoQuery.asp?courseNumber=<%=courseNumber%>&termId=<%=termId%>'">
		    </td>
      </tr>
	 </table>
 </form>
