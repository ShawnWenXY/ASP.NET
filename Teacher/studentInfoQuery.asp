...
<BODY>
 ...
 <form name="form1" method="post" action="studentInfoQuery.asp">
 <tr style="color:blue;font-size:14px;">
	     <td style="height: 14px" colspan=8 align="center">
		      <img src="../images/list.gif" width=14px height=14px>学生信息管理--&gt;学生信息查询
			 </td>
	   </tr><br>
 <tr>
				   ...
				   <%
					   sqlString = "select classNumber,className from [classInfo]"
						 ...
						 while not classInfoRs.EOF
						   selected = ""
							 if Request("studentClass") = classInfoRs("classNumber") then
							   selected = "selected"
							 end if
  ...
  <tr align="center"> 
    ...
    <td nowrap>&nbsp;<a href="studentDetails.asp?studentNumber=<%=studentInfoRs("studentNumber")%>&studentQueryNumber=<%=studentNumber%>&studentQueryName=<%=studentName%>&studentQueryClass=<%=studentClass%>"><img src="../images/edit.gif" border=0 height=12 width=12>详细</a></td>
  </tr>
  <%
